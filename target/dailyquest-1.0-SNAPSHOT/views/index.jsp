    ...
    <div class="row ">
        <div class="col">
            <div class="mt-5">
                ...
                <p class="h6 text-center text-secondary"> A convenient way to get additional hands</p>
                <p class=" text-justify mt-4">
                   The app acts as a portal for People to scout other people to perform daily jobs or odd tasks refered in the app as <span class="text-warning fs-4 fw-bold">Quests</span> 
                ...
                <p class="text-justify">
                    It enables <span class="text-success fw-bold fs-4"> flexible </span> working schedules for <span class="text-secondary fs-4 fw-bold "> Seekers </span> for most jobs being usually done in less than a day. 
                    You can stack jobs as long as it doesn't conflict with other time schedules, so its easy to earn extra. 
                </p>
