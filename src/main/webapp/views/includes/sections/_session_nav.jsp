            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li>
                            <s:url var="get_history" action="getAllHistory"/>
                            <s:a class="dropdown-item" href="%{get_history}">My History</s:a>
                        </li>
                        <li>
                            <!-- <s:url var="get_user" action="fetchUser"/> -->
                            <s:url var="get_user" action="fetchUser">
                                <s:param name="userBean.userID" value="#session.sessionUserID"/>
                            </s:url>
                            <s:a class="dropdown-item" href="%{get_user}">My Profile</s:a>
                        </li>
                        <li>
                        <hr class="dropdown-divider"></li>
                        <li>
                            <s:url var="sign_out" action="logoutSession"/>
                            <s:a class="dropdown-item" href="%{sign_out}">Sign Out</s:a>
                        </li>
                    </ul>
                </li>
            </ul>
