...
public class SearchQuestBoard extends ActionSupport implements SessionAware{
    ...
    public String execute() throws Exception {
        ...
        if(QuestDAO.searchAllQuestFromDB(searchTitle) == null){
            setDisplayMessage("No quest available yet...");
        }else{
            this.quests = QuestDAO.searchAllQuestFromDB(searchTitle).stream()
